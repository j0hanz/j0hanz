...
[![Skills](https://skillicons.dev/icons?i=html,css,js,ts,react,bootstrap,materialui,py,django,nodejs,npm,postgres,git,heroku,powershell,vite,md,raspberrypi,redux,vscode&perline=10)](https://skillicons.dev)
